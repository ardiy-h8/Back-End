...
describe('User resolvers', function () {
  test('Query all users', _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
  ...
  test('Mutation create user', _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
  ...
  test('Mutation update user', _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
  ...
  test('Mutation delete user', _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
  ...
  test('User not created if input empty', _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5() {
    var response, createUser;
